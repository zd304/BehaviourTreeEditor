...
NodeInfoWeightRandomSequence::NodeInfoWeightRandomSequence()
	: NodeInfoRandom(NodeType::WeightRandomSequence)
{
}

void NodeInfoWeightRandomSequence::OnGUI()
{
...
cJSON* NodeInfoWeightRandomSequence::Save(cJSON* parentArray)
{
...
void NodeInfoWeightRandomSequence::Load(cJSON* self)
{
